...
# Update:
Bot has been updated. Now, you can add the bot many servers. The server information will be in guilds file. And DB (postgresql) has been added to "with_db" branch
